...
function preload(){
backgrImage = loadImage("assets/clouds.gif") ;
backgrImage2 = loadImage("assets/city.jpg") ;
backgrImage3 = loadImage("assets/spacefree.gif") ;
backgrImage4 = loadImage("assets/Nightmoon.gif") ;  
hogImage = loadImage("assets/hedgehog.gif") ;
invisiblegrImage = loadImage("assets/sky.png") ;
coin1Image = loadImage("assets/coin1.gif") ;
coin2Image = loadImage("assets/coin2.gif") ;  
wiplantImage = loadImage("assets/wildplant.png") ;
wildtortImage = loadImage("assets/wildtortoise.png") ;
goombaImage = loadImage("assets/goomba.png")  
flygombaImage = loadImage("assets/flyinggoomba.png") ;
restartImage = loadImage("assets/reset.png") ;
playImage = loadImage("assets/play.png") ;
gameoverImage = loadImage("assets/gameover.png") ;
controlsImage = loadImage("assets/controls.png") ;
soniclogoImage = loadImage("assets/sonic.png") ;
sonicCoinImage = loadImage("assets/sonicCoin.png") ;
bombImage = loadImage("assets/bomb.png") ;
hedgehogImage = loadImage("assets/hedgehog.png") ;
background_sound = loadSound("helping.mp3") ;
eggdroneImage = loadImage("assets/eggdrone.png") ;
